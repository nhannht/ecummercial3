            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    We believe in the power of technology to transform the way people shop and do business. Our platform
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Our commitment to innovation, customer service, and ethical business practices has been the driving
                    force behind our success. We're proud to have built a platform that empowers entrepreneurs and small
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    ...
                    professionals bring a wealth of experience and expertise to the table, working tirelessly to ensure
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    ...
                    Acme Ecommerce family is committed to our mission of empowering entrepreneurs and small businesses.
