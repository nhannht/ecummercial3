...
function OtherImagesList(props: { otherImagesUrls: string[],
    ...
    return <div className="grid gap-4">
        <div className="grid grid-cols-3 gap-4">
            ...
            {props.otherImagesUrls.length > 3 && (
                <div className="border rounded-lg overflow-hidden flex items-center justify-center text-center text-muted-foreground">
                              ...
                              <div className="flex gap-4">
                                  ...
                                  <div className="grid gap-2">
                                      ...
                                      <p className="text-sm text-muted-foreground">
                                          This backpack is amazing! It's durable, comfortable, and has plenty of storage
                                          space. Highly
                                          recommend.
                                      </p>
                                  </div>
